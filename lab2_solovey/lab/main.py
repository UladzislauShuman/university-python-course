    ...
    while True:
        ...
        try:
            ...
            if choice == '1':
                ...
                students = io_utils.load_students_from_csv(filepath, has_header)
            ...
            # --- 2. Сохранение в CSV ---
                ...
                io_utils.save_students_to_csv(filepath, students, include_header)
            ...
            # --- 4. Добавление студента ---
                ...
                try:
                    ...
                    if any(s.id == new_id for s in students):
                        raise errors.DuplicateStudentIdError(f"Студент с ID {new_id} уже существует.")
            ...
            # --- 5. Удаление студента ---
                ...
                try:
                    ...
                    if student_to_delete:
                        ...
                        raise errors.StudentNotFoundError(f"Студент с ID {del_id} не найден.")
                except ValueError:
                ...
                try:
                    ...
                    if student_to_update:
                        ...
                        for grade in new_grades:
                            if not (0 <= grade <= 100):
                                raise errors.DataValidationError("Оценки должны быть в диапазоне от 0 до 100.")
                        student_to_update.grades = new_grades
                        print("Оценки успешно обновлены.")
                    else:
                        raise errors.StudentNotFoundError(f"Студент с ID {upd_id} не найден.")
                except ValueError:
                    print("Ошибка: ID и оценки должны быть числами.")
                except errors.DataValidationError as e:
                    print(f"Ошибка валидации: {e}")
            ...
            # --- 9. Сортировка ---
                ...
                sorted_students = processing.sort_students(students, sort_key)
        ...
        except errors.StudentAppException as e:
